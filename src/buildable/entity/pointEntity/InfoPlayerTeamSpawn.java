...
public class InfoPlayerTeamSpawn extends PointEntityRotateable
{
  ...
  public InfoPlayerTeamSpawn create(Point origin) {
    return new InfoPlayerTeamSpawn(origin, getRotation(), teamNumber);
  }
  ...
  public void writeVmf(Counter cc, Writer w) throws java.io.IOException
  {
    w.write("entity\n");
    w.write("{\n");
