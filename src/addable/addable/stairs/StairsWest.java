...
public class StairsWest
  extends Stairs
{
  public StairsWest()
  {
    int[] temp = { 314, 317, 320, 323, 326, 393, 415, 422, 429 };
  ...
  public Iterable<Addable> getInstances()
  {
    ...
    list.add(new StairsWest(314, 297));
    list.add(new StairsWest(317, 298));
    list.add(new StairsWest(320, 299));
    list.add(new StairsWest(323, 300));
    list.add(new StairsWest(326, 302));
    list.add(new StairsWest(393, 400));
    list.add(new StairsWest(415, 401));
    list.add(new StairsWest(422, 402));
    list.add(new StairsWest(429, 296));
